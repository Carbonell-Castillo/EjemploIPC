 ...
 * @author devcast
 */
public class PanelInvestigador extends javax.swing.JFrame {

    /**
     * Creates new form PanelInvestigador
     */
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Panel Investigador");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelInvestigador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelInvestigador().setVisible(true);
            }
        });
    }
